...
class MemberDateController extends Controller
{
     ...
     *
     * @Route("/new", name="lidBewerken_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('lidBewerken_show', array('id' => $memberDate->getId()));
        }
     ...
     *
     * @Route("/{id}", name="lidBewerken_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="lidBewerken_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, MemberDate $memberDate)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('lidBewerken_edit', array('id' => $memberDate->getId()));
        }
     ...
     *
     * @Route("/{id}", name="lidBewerken_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, MemberDate $memberDate)
    {
        ...
        return $this->redirectToRoute('lidBewerken_index');
    }
    ...
    private function createDeleteForm(MemberDate $memberDate)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('lidBewerken_delete', array('id' => $memberDate->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
